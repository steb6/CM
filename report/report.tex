...
In line 6 of algorithm 3, we used \textit{numpy.linalg.inv} to compute the inverse of \textit{R}, which does a back substitution because \textit{R} is upper-triangular.
