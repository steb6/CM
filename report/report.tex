...
%This happens because the best solution that we can find is still far away to give us a residual $\left\lVert Ax - b \right\rVert$ close to zero, and it can be arbitrarily large because it depends on the problem, and how well we can extract $b$ from $Im(A)$.
